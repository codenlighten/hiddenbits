var bsv = (function (t) {
  ...
  function (t, e, r) {
    (function (e) {
      e.browser ? (t.exports = r(85)) : (t.exports = r(86));
    }).call(this, r(38));
  },
  function (t, e, r) {
    "use strict";
  ...
  function (t, e, r) {
    (t.exports = r(51)), (t.exports.Interpreter = r(52));
  },
  function (t, e, r) {
    "use strict";
    var n = r(17),
  ...
  function (t, e, r) {
    ...
    (function (e) {
      var n = r(0),
        ...
        m = p.SCRIPT_ENABLE_SIGHASH_FORKID,
        g = function (t, f, h, g, y, v) {
          var _ = r(54),
            S = r(41);
          l.isUndefined(v) && (v = m);
          var w,
          ...
          ((g = new s(g)), v & p.SCRIPT_ENABLE_REPLAY_PROTECTION) &&
            (f = ((16711680 | (57005 ^ (f >> 8))) << 8) | (255 & f));
          if (f & i.SIGHASH_FORKID && v & p.SCRIPT_ENABLE_SIGHASH_FORKID)
              ...
              r & i.SIGHASH_ANYONECANPAY ||
                ...
                (31 & r) !== i.SIGHASH_SINGLE && (31 & r) !== i.SIGHASH_NONE
                  ...
                  : (31 & r) === i.SIGHASH_SINGLE &&
                    ...
                    (m = h(t, n));
              var g = new a();
              g.writeInt32LE(t.version),
                g.write(p),
                g.write(b),
                g.writeReverse(f.prevTxId),
                g.writeUInt32LE(f.outputIndex),
                g.writeVarintNum(s.toBuffer().length),
                g.write(s.toBuffer()),
                g.writeUInt64LEBN(o);
              var y = f.sequenceNumber;
              return (
                g.writeUInt32LE(y),
                g.write(m),
                g.writeUInt32LE(t.nLockTime),
                g.writeUInt32LE(r >>> 0),
                g.toBuffer()
              );
            })(I, f, h, g, y);
          ...
          if (
            ((I.inputs[h] = new S(I.inputs[h]).setScript(g)),
            (31 & f) === i.SIGHASH_NONE || (31 & f) === i.SIGHASH_SINGLE)
          )
            for (w = 0; w < I.inputs.length; w++)
              w !== h && (I.inputs[w].sequenceNumber = 0);
          if ((31 & f) === i.SIGHASH_NONE) I.outputs = [];
          else if ((31 & f) === i.SIGHASH_SINGLE) {
            if (h >= I.outputs.length) return b;
            for (I.outputs.length = h + 1, w = 0; w < h; w++)
              I.outputs[w] = new o({
          ...
          return (
            f & i.SIGHASH_ANYONECANPAY && (I.inputs = [I.inputs[h]]),
            new a().write(I.toBuffer()).writeInt32LE(f).toBuffer()
          );
        },
        y = function (t, e, r, n, i, s) {
          var o = g(t, e, r, n, i, s);
          if (0 === o.compare(b)) return o;
          var a = c.sha256sha256(o);
          return (a = new f(a).readReverse());
        };
      t.exports = {
        sighashPreimage: g,
        sighash: y,
    ...
    (t.exports = a),
      ...
      (a.prototype._fixedNafMul = function (t, e) {
        ...
        for (o = 0; o < n.length; o += r.step) {
          a = 0;
          for (var c = o + r.step - 1; c >= o; c--) a = (a << 1) + n[c];
          u.push(a);
        }
        for (
          ...
          for (o = 0; o < u.length; o++)
            (a = u[o]) === p
              ...
              : a === -p && (d = d.mixedAdd(r.points[o].neg()));
          h = h.add(d);
        }
        return h.toP();
      }),
      ...
      (a.prototype._wnafMulAdd = function (t, e, r, n, i) {
        var f,
          ...
          p = 0;
        for (f = 0; f < n; f++) {
          var l = (u = e[f])._getNAFPoints(t);
          (c[f] = l.wnd), (h[f] = l.points);
        }
        for (f = n - 1; f >= 1; f -= 2) {
          var b = f - 1,
            m = f;
          if (1 === c[b] && 1 === c[m]) {
            ...
            for (
              ...
              var _ = 0 | v[0][a],
                S = 0 | v[1][a];
              (d[b][a] = y[3 * (_ + 1) + (S + 1)]), (d[m][a] = 0), (h[b] = g);
            }
          } else
            (d[b] = s(r[b], c[b], this._bitLength)),
              (d[m] = s(r[m], c[m], this._bitLength)),
              (p = Math.max(d[b].length, p)),
              (p = Math.max(d[m].length, p));
        }
        ...
        for (f = p; f >= 0; f--) {
          for (var A = 0; f >= 0; ) {
            var E = !0;
            for (a = 0; a < n; a++)
              (I[a] = 0 | d[a][f]), 0 !== I[a] && (E = !1);
            if (!E) break;
            A++, f--;
          }
          if ((f >= 0 && A++, (w = w.dblp(A)), f < 0)) break;
          for (a = 0; a < n; a++) {
            var P = I[a];
            0 !== P &&
              (P > 0
  ...
  function (t, e, r) {
    (t.exports = r(54)),
      (t.exports.Input = r(41)),
      (t.exports.Output = r(16)),
      (t.exports.UnspentOutput = r(55)),
      (t.exports.Signature = r(26)),
      (t.exports.Sighash = r(15));
  },
  function (t, e, r) {
    "use strict";
    (function (e, n) {
  ...
  function (t, e, r) {
    (t.exports = r(25)),
      (t.exports.PublicKey = r(96)),
      (t.exports.PublicKeyHash = r(97)),
      (t.exports.MultiSig = r(98)),
      (t.exports.MultiSigScriptHash = r(99));
  },
  function (t, e, r) {
    "use strict";
    (function (e) {
  ...
  function (t, e, r) {
    "use strict";
    var n = e;
    (n.base = r(27)), (n.short = r(68)), (n.mont = r(69)), (n.edwards = r(70));
  },
  function (t, e, r) {
    "use strict";
    var n = r(11).rotr32;
  ...
  function (t, e, r) {
    ...
    (function (e, n) {
      ...
      (i.version = "v" + r(63).version),
        ...
        (i.encoding.BufferReader = r(14)),
        (i.encoding.BufferWriter = r(13)),
        ...
        (i.deps.bs58 = r(50)),
        (i.deps.Buffer = n),
        (i.deps.elliptic = r(43)),
        (i.deps._ = r(1)),
        (i.Transaction.sighash = r(15));
  ...
  function (t, e, r) {
    ...
    s(a, o),
      (t.exports = a),
      (a.prototype._getEndomorphism = function (t) {
        if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) {
          ...
          if (t.lambda) r = new i(t.lambda, 16);
            ...
            0 === this.g.mul(s[0]).x.cmp(this.g.x.redMul(e))
              ? (r = s[0])
              : ((r = s[1]), f(0 === this.g.mul(r).x.cmp(this.g.x.redMul(e))));
          }
          return {
            beta: e,
            lambda: r,
      ...
      (a.prototype._getEndoBasis = function (t) {
        for (
          ...
          var _ = g.sub(v.mul(b));
          if (!n && u.cmp(h) < 0)
            (e = a.neg()), (r = l), (n = u.neg()), (s = c);
          else if (n && 2 == ++y) break;
          (a = u), (p = d), (d = u), (m = l), (l = c), (g = b), (b = _);
        }
        (o = u.neg()), (f = c);
        var S = n.sqr().add(s.sqr());
        return (
      ...
      s(c, o.BasePoint),
      (a.prototype.jpoint = function (t, e, r) {
      ...
      (c.prototype.dblp = function (t) {
        ...
        for (e = 0; e < t; e++) {
          ...
          var y = u.redMul(f);
          e + 1 < t && (a = a.redMul(d)), (s = b), (f = y), (u = g);
        }
    ...
    s(a, o),
      ...
      (u.prototype._projDbl = function () {
        ...
        if (this.curve.twisted) {
          ...
          this.zOne
            ? ((t = o.redSub(f).redSub(a).redMul(u.redSub(this.curve.two))),
              (e = u.redMul(n.redSub(a))),
              (r = u.redSqr().redSub(u).redSub(u)))
            : ((i = this.z.redSqr()),
              (s = u.redSub(i).redISub(i)),
              (t = o.redSub(f).redISub(a).redMul(s)),
              (e = u.redMul(n.redSub(a))),
              (r = u.redMul(s)));
        } else
          (n = f.redAdd(a)),
            ...
            (t = this.curve._mulC(o.redISub(n)).redMul(s)),
            (e = this.curve._mulC(n).redMul(f.redISub(a))),
            (r = n.redMul(s));
  ...
  function (t, e, r) {
    ...
    function h(t) {
      if (!(this instanceof h)) return new h(t);
      "string" == typeof t &&
        (a(Object.prototype.hasOwnProperty.call(o, t), "Unknown curve " + t),
        (t = o[t])),
    ...
    (t.exports = h),
      ...
      (h.prototype.sign = function (t, e, r, s) {
        ...
        for (
          ...
          var p = s.k ? s.k(d) : new n(u.generate(this.n.byteLength()));
      ...
      (h.prototype.recoverPubKey = function (t, e, r, i) {
        ...
        var p = e.r.invm(s),
          l = s.sub(o).mul(p).umod(s),
          b = u.mul(p).umod(s);
        return this.g.mulAdd(l, f, b);
      }),
